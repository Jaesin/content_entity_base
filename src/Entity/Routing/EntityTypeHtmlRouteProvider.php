...
/**
 * @file
 *   Contains \Drupal\content_entity_base\Entity\Routing\EntityTypeHtmlRouteProvider.
 */
...
/**
 * Provides routes for custom content entities bundles.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class EntityTypeHtmlRouteProvider extends AdminHtmlRouteProvider {
  /**
   * {@inheritdoc}
   */
  public function getRoutes(EntityTypeInterface $entity_type) {
    ...
    if ($add_form_route = $this->getAddFormRoute($entity_type)) {
      $routes->add("entity.{$entity_type_id}.add_form", $add_form_route);
    }
